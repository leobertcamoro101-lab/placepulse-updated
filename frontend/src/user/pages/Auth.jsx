//with Card component and some styling changes
  ...
  const authSubmitHandler = async (event) => {
    ...
    if (isLoginMode) {
      ...
      const responseData = await sendRequest(
        ...
        auth.login(responseData.userId, responseData.token, undefined, responseData.name, responseData.image);
...
//                 // errorText="Please enter a name."
//                 onInput={inputHandler}
//                 className="w-full rounded-full border border-gray-300 px-4 py-3 mb-3 text-base focus:outline-none focus:border-blue-500"
//               />
//             )}
//             {!isLoginMode && (
...
//               // errorText="Please enter a valid password, at least 6 characters."
//               onInput={inputHandler}
//               className="w-full rounded-full border border-gray-300 px-4 py-3 mb-4 text-base focus:outline-none focus:border-blue-500"
//             />
//             <Button
//               type="submit"
//               disabled={!formState.isValid}
...
//               inverse
//               onClick={switchModeHandler}
//               className="rounded-full border border-blue-600 text-blue-600 font-semibold px-6 py-3 hover:bg-blue-600 hover:text-white mb-4"
//             >
//               {isLoginMode ? "Create New Account" : "Switch to Login"}
//             </Button>
//           </div>
