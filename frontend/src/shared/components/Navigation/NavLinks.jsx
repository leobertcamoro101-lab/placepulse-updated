  ...
  const linkClasses = ({ isActive }) => 
    `border text-sm block p-2 transition-colors ${
      isActive 
        ...
        : 'border-transparent text-[#292929] md:text-white hover:bg-[#f8df00] hover:border-[#292929] hover:text-[#292929] active:bg-[#f8df00] active:border-[#292929] active:text-[#292929]'
    }`;
