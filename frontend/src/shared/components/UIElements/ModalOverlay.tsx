import { useEffect, useState, ReactNode, FormEventHandler, CSSProperties } from "react";
...
const ModalOverlay = ({
  ...
  // const handleTransitionEnd: FormEventHandler<HTMLDivElement> extends never
  //   ? never
  //   : (e: React.TransitionEvent<HTMLDivElement>) => void = (e) => {
