      ...
      <Card className="w-[90%] max-w-[35rem] mx-auto my-4 p-0 overflow-visible">
        ...
        <form onSubmit={placeSubmitHandler} className="px-4 pb-4">
          <Input
            ...
            // className="w-full rounded border-bg-[#FFFFFF] !border-0 !px-0 !py-2 text-xl font-medium placeholder:text-gray-500 focus:!outline-none"
          ...
          <Input
            ...
            onInput={inputHandler}
            // className="w-full rounded border-bg-[#FFFFFF] !border-0 !px-0 !py-1 text-base placeholder:text-gray-500 focus:!outline-none"
            className="w-full rounded bg-[#FFFFFF] border border-gray-300 px-4 py-3 mb-3 text-base focus:outline-none focus:border-blue-500"
          />
          <Input
            id="address"
            ...
            onInput={inputHandler}
            // className="w-full rounded border-bg-[#FFFFFF] !border-0 !px-0 !py-1 text-base placeholder:text-gray-500 focus:!outline-none mb-3"
            className="w-full rounded bg-[#FFFFFF] border border-gray-300 px-4 py-3 mb-3 text-base focus:outline-none focus:border-blue-500"
          />
